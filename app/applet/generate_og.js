...
<svg width="500" height="500" viewBox="0 0 500 500" xmlns="http://www.w3.org/2000/svg">
  ...
  <!-- Instagram Handle -->
  <text x="480" y="474" font-family="'Nanum Pen Script', 'Comic Sans MS', cursive, sans-serif" font-size="19" font-weight="bold" fill="#537293" text-anchor="end">@mushroom.pino</text>
</svg>
`;
...
async function main() {
  try {
    ...
    // Composite the SVG onto the crumpled paper background
