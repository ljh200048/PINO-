        ...
        const initialReviews: Omit<Review, 'id'>[] = [
          {
            ...
            imageUrl: "https://images.unsplash.com/photo-1472491235688-bdc81a63246e?w=400&auto=format&fit=crop&q=80",
      ...
      if (classesSnap.empty) {
        ...
        const SEED_CLASSES = [
          ...
          },
          {
            ...
            image: "https://images.unsplash.com/photo-1472491235688-bdc81a63246e?w=600&auto=format&fit=crop&q=80",
          ...
          const SEED_CLASS_REVIEWS = [
            {
              ...
              imageUrl: "https://images.unsplash.com/photo-1472491235688-bdc81a63246e?w=600&auto=format&fit=crop&q=80",
              createdAt: Date.now() - 3 * 24 * 60 * 60 * 1000
            },
            {
